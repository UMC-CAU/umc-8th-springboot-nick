...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.ReviewPreviewListDTO> getMemberReviewList(@PathVariable(name = "memberId") Long memberId, @RequestParam(name = "page") Integer page) {
